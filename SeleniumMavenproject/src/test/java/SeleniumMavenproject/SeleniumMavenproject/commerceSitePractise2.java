...
public class commerceSitePractise2 {
	...
	public static void main(String[] args) {
		...
		WebElement sortFilter = driver.findElement(By.id("products-orderby"));
		action.moveToElement(sortFilter).build().perform();
		
		WebElement lowHighFilter = driver.findElement(By.xpath("//option[contains(text(),'Price: Low to High')]"));
		js.executeScript("arguments[0].click();", lowHighFilter);
